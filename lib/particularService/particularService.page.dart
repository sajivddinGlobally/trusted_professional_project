...
import 'package:trusted_profissional_app/particularService/serviceParticular/controllerParticularService.dart';

class ParticularService extends ConsumerStatefulWidget {
  const ParticularService({super.key});
...
class _ParticularServiceState extends ConsumerState<ParticularService> {
  ...
  Widget build(BuildContext context) {
    final particullerData = ref.watch(particularServiceProvider);
    return Scaffold(
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Stack(
                        children: [
                          Image.network(
                            ...
                            particularservice.data[index].image,
                          ),
                          Positioned(
                            left: 20.w,
                            top: 60.h,
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              ...
                              particularservice.data[index].title,
                              style: GoogleFonts.inter(
                                fontWeight: FontWeight.w500,
                                fontSize: 20.sp,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ServiceGallary(image: "assets/gallery1.png"),
                            SizedBox(width: 8.w),
                            ServiceGallary(image: "assets/gallery2.png"),
                            SizedBox(width: 8.w),
                            ServiceGallary(image: "assets/gallery3.png"),
                          ],
                        ),
                      ),
                      SizedBox(height: 20.h),
                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: ServiceGallary(image: "assets/rakesh.png"),
                          ),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
