...
ParticularServiceModel particularServiceModelFromJson(String str) =>
    ParticularServiceModel.fromJson(json.decode(str));

String particularServiceModelToJson(ParticularServiceModel data) =>
...
class ParticularServiceModel {
  ...
  ParticularServiceModel({required this.message, required this.data});

  factory ParticularServiceModel.fromJson(Map<String, dynamic> json) =>
