...
//
//     final exmapleModel = exmapleModelFromJson(jsonString);

import 'dart:convert';

ExmapleModel exmapleModelFromJson(String str) => ExmapleModel.fromJson(json.decode(str));

String exmapleModelToJson(ExmapleModel data) => json.encode(data.toJson());
...
class ExmapleModel {
    ...
    factory ExmapleModel.fromJson(Map<String, dynamic> json) => ExmapleModel(
